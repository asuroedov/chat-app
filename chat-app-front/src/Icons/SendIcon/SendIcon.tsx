...
const SendIcon = ({ className, onClick }: { className?: string; onClick: () => void }) => {
  return (
    <svg
      className={className}
      onClick={onClick}
